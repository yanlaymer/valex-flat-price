...
def main():
    ...
    input_type = st.radio("Как вы хотите указать местоположение?\n(Поиск по адресу может быть некорректным. Рекомендуется использовать широту и долготу.)", ["Введите адрес", "Введите широту и долготу"])
